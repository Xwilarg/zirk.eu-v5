let gamejams = [
    ...
    },
    {
        ...
        "location": "Online",
        "theme": [ "Heritage of Ukraine", "Economic and Social Cooperation in Eastern and Central Europe" ],
    ...
    },
    {
        ...
        "location": "Online",
        "theme": [ "Time" ],
        "event": "Game Boy Showdown",
        "date": "2022-05-22",
        "duration": 168,
        "engine": "GB Studio",
        "github": "https://github.com/Xwilarg/DontWasteYourTime",
        "website": "https://itch.io/jam/game-boy-showdown/rate/1550843",
    ...
    return `
        <span id="jam-${jam.name}${idCmpl}">
            <span class="jamInfoText">
                <p class="jamTitle">${jam.event} - ${jam.duration} hour${jam.duration > 1 ? "s" : ""}<br/>${(jam.theme.length > 0 ? jam.theme[0] : "")}</p>
